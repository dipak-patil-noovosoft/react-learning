...
var browserHistory = /*#__PURE__*/createBrowserHistory();
...
var createMatchingRouterState = function createMatchingRouterState(location, routes, queryParseOptions) {
  ...
  for (var rIndex = 0; rIndex < routes.length; rIndex++) {
    ...
    for (var pIndex = 0; pIndex < patterns.length; pIndex++) {
      ...
      if (params) {
        var queryParams = parse(location.search, queryParseOptions);
...
var getGenerator = function getGenerator(pattern) {
  ...
  var compiledGenerator = compile(pattern);
...
var RouterContext = /*#__PURE__*/React.createContext(undefined); // ---------- useRouterStore ----------

function useRouterStore() {
  var routerStore = useContext(RouterContext);
...
var RouterLink = /*#__PURE__*/observer(function (_ref) {
...
var RouterView = /*#__PURE__*/observer(function (_ref) {
  var viewMap = _ref.viewMap;
  var routerStore = useRouterStore();
  var routerState = routerStore.routerState;
  debug$3('render %o', routerState);
  var view = viewMap[routerState.routeName];
  return view ? React.createElement(Fragment, null, view) : null;
});

export { HistoryAdapter, RouterContext, RouterLink, RouterStore, RouterView, StaticAdapter, TransitionState, browserHistory, createMatchingRouterState, createRouterState, generateUrl, matchUrl, routerStateToUrl, useRouterStore };
//# sourceMappingURL=mobx-state-router.esm.js.map
